...
impl PersonElm {
    fn new(p: Arc<Mutex<Person>>) -> PersonElm {
        ...
        let mut _tbox = TextBox::new("Fasih's full name is فصیح احمد رانا, and his first name means eloquent. lorem עִבְרִית ipsum doler.".to_owned());
        //let mut _tbox = TextBox::new("فصیح کا پورا نام Fasih Ahmed Rana ہے، اور انگریزی میں اس کے نام کا مطلب eloquent ہے.".to_owned());
